...
public class SkeletonTools: EditorWindow
{
	...
	// collider
	string							collider_template_path	= "Assets/Noitom/PerceptionNeuron/Resources/Prefabs/Robot Colliders Template.prefab";
    string                          collider_template_path2 = "Assets/Noitom/PerceptionNeuron/Resources/Prefabs/Robot Colliders Template.prefab";
	...
	void OnSelectionChange()
	{
		...
		for( int i = 0; i < Selection.transforms.Length; ++i )
		{
            ...
            {
                new_objects.Add(t.gameObject);
                new_prefixes.Add(default_prefix);
            }
        }
