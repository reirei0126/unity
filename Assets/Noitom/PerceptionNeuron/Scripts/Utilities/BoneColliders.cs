...
namespace Neuron
{
	public static class BoneColliders
	{
		...
		public static void AddSkeletonColliderRenderers( Transform root, string prefix, Color color )
		{
			...
			Material mat = UnityEditor.AssetDatabase.LoadAssetAtPath<Material>("Assets/Noitom/PerceptionNeuron/Resources/Materials/BoneColliderMaterial.mat");
            if(mat == null)
                mat = UnityEditor.AssetDatabase.LoadAssetAtPath<Material>("Assets/Noitom/PerceptionNeuron/Resources/Materials/BoneColliderMaterial.mat");
            if ( mat != null )
			{
				mat.color = color;
			}
			...
			{
				Debug.LogError( string.Format("[NeuronBonColliders] Can not find \"Assets/Noitom/PerceptionNeuron/Resources/Materials/BoneColliderMaterial.mat\".") );
			}
